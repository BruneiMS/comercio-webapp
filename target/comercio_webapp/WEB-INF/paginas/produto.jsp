...
<head>
	...
	<script src='<spring:url value="/resources/js/jquery-3.5.1.min.js" />' ></script> <!-- Aqui vamos precisar do jquery -->
...
<body>
	...
	<div class="container mt-5"> <!-- essa classe vai direcionar nosso conteudo para o meio da pagina -->
		<div class="row">
			...
			<!-- mas devemos mostrar essa mensagem somente quando da erro -->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#divMensagemErro').delay(2000).fadeOut('slow');
			$('#divMensagemSucesso').delay(2000).fadeOut('slow');
		});
	</script>
</body>
</html>